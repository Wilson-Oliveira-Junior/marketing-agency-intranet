...
Route::get('/backend/tarefas/usuarioTarefa', 					['uses'=>'Backend\TarefaController@usuarioTarefa',    	'as'=>'backend.tarefa.json.usuarioTarefa']);
...
Route::group(['middleware'=>'auth'],function(){
	...
	/************************** Tarefas ***************************/
		...
		/****** Comentários ******/
			...
			Route::get('/backend/tarefas/comentarios/deletar/{id}', 		['uses'=>'Backend\TarefaController@deletar_comentario',    		'as'=>'backend.tarefa.comentario.deletar']);
		/****** Fim Comentário ******/
		...
		/****** Anexos ******/
			...
			Route::get('/backend/tarefas/{id_tarefa}/anexos/all', 					['uses'=>'Backend\TarefaController@downloadAnexos',    			'as'=>'backend.tarefa.anexo.all']);
		/****** Fim Anexos ******/
	...
	/************************** Gatilhos **************************/
		...
		/* Guia Geral */
			...
			Route::get('/backend/gatilhos/testegatilhocron', 			['uses'=>'Backend\GatilhosController@testegatilhocron',     'as'=>'backend.gatilhos.teste'					]);
		/* Guia Geral */
