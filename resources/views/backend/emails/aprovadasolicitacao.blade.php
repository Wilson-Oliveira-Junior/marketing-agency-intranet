...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <div class="col-md-12 style-email">
            ...
            <h2>Solicita&ccedil;&atilde;o de Altera&ccedil;&atilde;o de Senha APROVADA!</h2>
            <div class="bloco-texto">
                    <p>Olá {{$arrDados['solicitadopor']}} {{$arrDados['solicitadopor_sobrenome']}},</p>
                    <p>Foi aprovada sua solicita&ccedil;&atilde;o de senha, com os dados abaixo:</p>
                    <p>Cliente: {{$arrDados['cliente']}}</p>
                    <p>Tipo: {{$arrDados['tipo']}}</p>
                    <p>Clique no botão abaixo para acessar a listagem.</p>
