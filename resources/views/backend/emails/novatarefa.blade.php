...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <div class="col-md-12 style-email">
            ...
            <h2>Uma Tarefa foi aberta !</h2>
            <div class="bloco-texto">
                <p>Olá {{ isset($responsavel) ? $responsavel : $setor }} {{ isset($responsavel_sobrenome) ? $responsavel_sobrenome : '' }},</p>
                <p>Foi aberto uma nova tarefa!</p>

                <p class="p-diferente"><span>Tarefa</span><br/> {{ $titulo }}</p>
                <p class="p-diferente"><span>Aberto Por</span><br/> {{ $aberta }} {{ $aberta_sobrenome }}</p>
