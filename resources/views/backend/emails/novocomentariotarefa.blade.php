...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <div class="col-md-12 style-email">
            ...
            <h2>Coment&aacute;rio na TAREFA !</h2>
            <div class="bloco-texto">
                <p>Olá,</p>
                <p>Foi feito um coment&aacute;rio na tarefa que voc&ecirc; esta!</p>

                <p class="p-diferente"><span>Tarefa</span><br/> {{ $titulo }}</p>
                <p class="p-diferente"><span>Respons&aacute;vel pelo coment&aacute;rio</span><br/> {{ $responsavel_comentairo }} {{ $responsavel_comentario_sobrenome }}</p>
                <p class="p-diferente"><span>Coment&aacute;rio</span><br/>{!! $comentario !!}</p>
