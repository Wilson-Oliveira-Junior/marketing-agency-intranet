    ...
    <body>
        <div class="col-md-12 style-email">
            ...
            <div class="bloco-texto">
                ...
                <p>Tem uma nova pauta pra você.</p>
                <p class="p-diferente"><span>Titulo</span><br/> {{ $titulo }}</p>
                <p class="p-diferente"><span>Urgência</span><br/> {{ $urgencia }}</p>
                @isset($data)
                <p class="p-diferente"><span>Data</span><br/> {{ $data }}</p>
                @endisset
                <p class="p-diferente"><span>Cliente</span><br/> {{ $cliente }}</p>
                <p class="p-diferente"><span>Criado Por</span><br/> {{ $criadopor }}</p>
