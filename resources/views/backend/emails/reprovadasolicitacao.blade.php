    ...
    <body>
        <div class="col-md-12 style-email">
            ...
            <div class="bloco-texto">
                    ...
                    <p>Foi reprovada sua solicita&ccedil;&atilde;o de senha, com os dados abaixo:</p>
                    <p>Cliente: {{$arrDados['cliente']}}</p>
                    <p>Tipo: {{$arrDados['tipo']}}</p>
                    <p>Motivo: {{$arrDados['motivo']}}</p>
                    <p>Clique no botão abaixo para acessar a listagem e solicitar uma nova altera&ccedil;&atilde;o.</p>
