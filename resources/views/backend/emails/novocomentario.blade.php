    ...
    <body>
        <div class="col-md-12 style-email">
            ...
            <div class="bloco-texto">
                <p>Olá</p>
                <p>{{ $aberta }} fez um comentário no lembrete "{{ $lembrete }}"</p>
                
                <p class="p-diferente"><span>Lembrete</span><br/> {{ $lembrete }}</p>
                <p class="p-diferente"><span>Aberto Por</span><br/> {{ $aberta }}</p>
                <p class="p-diferente" style="padding-bottom: 0px;margin-bottom: -5px;"><span>Comentário</span></p>
