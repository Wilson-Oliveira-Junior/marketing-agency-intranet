    ...
    <div class="col">
        <div class="card shadow">
            <div class="card-header border-0">
                <h3 class="mb-0">Adicionando Senha " - {{ $clientes->nome_fantasia }} - "</h3>
            </div>
            <form action="{{ route('backend.cliente.salvarRegistroSenha') }}" method="post" style="align-items: center;display: flex;flex-wrap: wrap;">
                {{ csrf_field() }}
