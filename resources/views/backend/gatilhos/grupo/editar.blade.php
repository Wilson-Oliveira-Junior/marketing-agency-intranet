    ...
    <div class="col">
        <div class="card shadow">
            <div class="card-header border-0">
                <h3 class="mb-0" style="float:left;width:85%">Editando Grupos Gatilho</h3>

                <a href="{{ route('backend.gatilhos.grupo') }}" class="btn btn-info" style="float: left;margin-top: -10px;">
                    VOLTAR
                </a>
            </div>
            <form action="{{ route('backend.gatilhos.grupo.atualizar',$gatilhos_grupos->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
