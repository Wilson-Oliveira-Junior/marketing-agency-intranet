    ...
    <div class="form-group" style="margin-top: 10px;">
        <div class="input-group input-group-alternative mb-3" style="padding: 0px;border: none;box-shadow: none;"> 
            ...
            <div id="convidado_evento" class="select2-container required-input">
                ...
                <!-- Campos para clicar -->
                <a href="javascript:void(0)" class="js-open-modal-convidado select2-choice select2-default" style="padding: 10px 0px;">
                    <span class="select2-chosen" id="select2-chosen-10">Compartilhe o Evento</span>
                ...
                <div class="search-convidado">
                    <input id="txtBuscaconvidado" type="text" class="form-control search-seguidor" placeholder="Digite para procurar" autofocus>
                    <img src="{{ asset('img/gif-carregamento.gif') }}" class="imagem-carregamento">
                </div>

                <!-- Conteudo -->
                <ul id="convidado-conteudo-id" class="conteudo-convidado">
                </ul>
            </div>
        </div>
    </div>
