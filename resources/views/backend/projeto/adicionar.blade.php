...
@section('name-page')
    ...
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('backend.projeto') }}" style="font-size: 11px;margin-bottom: -5px !important;">
        Projetos
    </a>
    <span style="color: #FFF;margin: 10px;"> / </span>
    ...
    <div class="col">
        <div class="card shadow">
            <div class="card-header border-0">
                <h3 class="mb-0">Adicionando Projeto</h3>
            </div>
            <form action="{{ route('backend.projeto.salvar') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                @include('backend.projeto._form')
